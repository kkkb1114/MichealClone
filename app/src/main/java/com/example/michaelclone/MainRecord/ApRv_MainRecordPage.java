...
public class ApRv_MainRecordPage extends RecyclerView.Adapter<ApRv_MainRecordPage.ViewHolder> {
    ...
    public ApRv_MainRecordPage(Context context){
        ...
        year = MainRecord_Data.MainRecordPageArrayList.get(0).year;
        month = MainRecord_Data.MainRecordPageArrayList.get(0).month;
    }
            ...
            if (MainRecord_Data.MainRecordPageArrayList.size() > 0){
                ...
                DecimalFormat decimalFormat = new DecimalFormat("###,###");
                    ...
                    if(isYear){
                        ...
                        holder.tv_mainrecordYear.setText(MainRecord_Data.MainRecordPageArrayList.get(0).year);
                    }
                ...
                if(isMonth){
                    ...
                    // 연, 월뷰 중복 기록은 숨기는 구간
                    if(year.equals(MainRecord_Data.MainRecordPageArrayList.get(position).year)){
                        isYear = true;
                    }else {
                        isYear = false;
                        year = MainRecord_Data.MainRecordPageArrayList.get(position).year;
                    }

                // 연, 월뷰 중복 기록은 숨기는 구간
                if(month.equals(MainRecord_Data.MainRecordPageArrayList.get(position).month)){
                    isMonth = true;
                }else {
                    isMonth = false;
                    month = MainRecord_Data.MainRecordPageArrayList.get(position).month;
                }
